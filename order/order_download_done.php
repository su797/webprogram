...
function get_rand_str2(){
    $length=rand(8,15);
    $str='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890';
    $rand_str = str_shuffle($str);
    $rands= substr($rand_str,0,$length);
    return $rands;
}

$rand_str=$year.$month.$day.'_'.get_rand_str2();

$file=fopen("./chumon{$rand_str}.csv",'w');
...
<a href="./chumon<?=$rand_str?>.csv">注文データのダウンロード</a><br />
<br />
